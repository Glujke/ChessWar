...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IAITurnScheduler, AITurnScheduler>();
        services.AddScoped<IOptimisticLockingService, OptimisticLockingService>();
        services.AddScoped<ICachingService, CachingService>();
        services.AddScoped<INotificationBatcher, NotificationBatcher>();

        services.AddSingleton<TurnQueueHub>();
