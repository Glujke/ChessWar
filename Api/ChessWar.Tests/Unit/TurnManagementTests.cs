...
public class TurnManagementTests
{
    ...
    public TurnManagementTests(ITestOutputHelper output)
    {
        ...
        _turnService = new TurnService(_movementRulesServiceMock.Object, _attackRulesServiceMock.Object, _evolutionServiceMock.Object, _TestConfig.CreateProvider(), new MockDomainEventDispatcher(), new PieceDomainService(), Mock.Of<ICollectiveShieldService>(), turnServiceLogger);
    ...
    {
        var player = _gameSession.Player1;
        player.SetMana(10, 10);
        var turn = new Turn(1, player);
        var piece = CreateTestPiece("piece1", PieceType.Pawn, Team.Elves, new Position(1, 1), player);
        piece.HP = 10;
        ...
        var enemyPlayer = _gameSession.Player2;
